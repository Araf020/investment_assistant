...
////                .itemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<>())
////                .sql("INSERT INTO per_share (comapny_code,year,dividend_per_share,cash_per_share," +
...
//
//    @Bean
//    public Step step1(JdbcBatchItemWriter<Growths> writer) {
//        return stepBuilderFactory
//                .get("step1")
//                .<InputDataSets, Growths>chunk(100)
//                .reader(reader())
//                .processor(processor())
//                .writer(writer)
//                .build();
