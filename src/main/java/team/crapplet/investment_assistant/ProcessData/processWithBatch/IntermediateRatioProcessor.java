...
//
//public class IntermediateRatioProcessor implements ItemProcessor<InputDataSets, Growths> { // edit here
//
...
//
//    @Override
//    public Growths process(InputDataSets inputDataSets) throws Exception {
//
