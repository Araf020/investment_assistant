...
public class IntermediateRatioProcessor implements ItemProcessor<InputDataSets, Sector> { // edit here
...
//        log.info(s + ":" +otherwise);
    ...
    @Override
    public Sector process(InputDataSets inputDataSets) throws Exception {
